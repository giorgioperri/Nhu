...
class Play extends Phaser.Scene {
	...
	createLayers(map) {
		...
		if (map.getLayer('ObstacleSprite') != null) {
			obstacleSprite = map.createLayer('ObstacleSprite', tileset1);
		}

		if (map.getLayer('ObstacleCollider') != null) {
			obstacleCollider = map.createLayer('ObstacleCollider', tileset1);
		}

		if (map.getLayer('TutorialTiles') != null) {
			tutorialTiles = map.createLayer('TutorialTiles', tileset1);
		}
	...
	createBG() {
		...
		this.bg1 = this.add
			.tileSprite(0, 0, this.config.width * 2, this.config.height * 2, 'gameplay-bg-1')
			.setDepth(-29)
			.setOrigin(0, 0)
			.setScale(0.85)
			.setScrollFactor(0, 1);
		...
		this.bg2 = this.add
			.tileSprite(0, 0, this.config.width * 2, this.config.height * 2, 'gameplay-bg-2')
			.setDepth(-28)
			.setOrigin(0, 0)
			.setScale(0.85)
			.setScrollFactor(0, 1);
		...
		this.bg3 = this.add
			.tileSprite(0, 0, this.config.width * 2, this.config.height * 2, 'gameplay-bg-3')
			.setDepth(-27)
			.setOrigin(0, 0)
			.setScale(0.85)
			.setScrollFactor(0, 1);
